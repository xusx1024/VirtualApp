...
public class VUserInfo implements Parcelable {
  ...
  public static final Parcelable.Creator<VUserInfo> CREATOR = new Parcelable.Creator<VUserInfo>() {
    @Override public VUserInfo createFromParcel(Parcel source) {
      return new VUserInfo(source);
    }

    @Override public VUserInfo[] newArray(int size) {
  ...
  @Override public void writeToParcel(Parcel dest, int parcelableFlags) {
    dest.writeInt(id);
