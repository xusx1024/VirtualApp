...
@Inject(MethodProxies.class) public class ActivityManagerStub
  ...
  @Override public void inject() throws Throwable {
    ...
    BinderInvocationStub hookAMBinder =
        new BinderInvocationStub(getInvocationStub().getBaseInterface());
  ...
  @Override protected void onBindMethods() {
    ...
    if (VirtualCore.get().isVAppProcess()) {
      ...
      addMethodProxy(new StaticMethodProxy("checkUriPermission") {
        @Override public Object afterCall(Object who, Method method, Object[] args, Object result)
            throws Throwable {
        ...
        @Override public Object call(Object who, Method method, Object... args) throws Throwable {
          ...
          List<ActivityManager.RecentTaskInfo> infos =
              ParceledListSliceCompat.isReturnParceledListSlice(method)
                  ? ParceledListSlice.getList.call(_infos) : (List) _infos;
  ...
  private class isUserRunning extends MethodProxy {
    ...
    @Override public Object call(Object who, Method method, Object... args) {
