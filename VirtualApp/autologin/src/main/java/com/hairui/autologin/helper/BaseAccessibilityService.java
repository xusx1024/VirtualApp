...
public class BaseAccessibilityService extends AccessibilityService {
   ...
   * @return View
   */
  @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2) public AccessibilityNodeInfo findViewByID(
      String id) {
    AccessibilityNodeInfo accessibilityNodeInfo = getRootInActiveWindow();
    if (accessibilityNodeInfo == null) {
      return null;
  ...
  @TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2) public void clickTextViewByID(String id) {
    AccessibilityNodeInfo accessibilityNodeInfo = getRootInActiveWindow();
    if (accessibilityNodeInfo == null) {
      return;
    }
  ...
  enum PackageName {
     ...
     * 包名
     */
    QQ("com.tencent.mobileqq"), WZRY("com.tencent.tmgp.sgame");
